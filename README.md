...
- Criar projeto: complementos -> gerenciar e instalar complementos -> na barra de busca clica em "Quickmap" -> QuickMapServices -> instalar complemento. O QuickMap services permite acessar dados de satélite de todo o mundo de diferentes bases de dados.
